...
//   const response = await axios.post(`/instructor/sections`, data);
//   return response.data;
// };
...
export const createSection = async (data) => {
  const response = await axiosInstance.post('/instructor/sections', data); // ✅ Changed axios to axiosInstance
  return response.data;
};
