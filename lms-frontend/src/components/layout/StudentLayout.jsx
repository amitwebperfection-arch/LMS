  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-900">
      ...
      >
        <div className="flex flex-col h-full">
          <div className="p-6 border-b border-gray-200 dark:border-dark-700 flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-primary-600 whitespace-nowrap">LMS Student</h1>
          </div>
      ...
      <div className="lg:ml-64">
        ...
        <footer className="bg-gray-100 dark:bg-dark-950 border-gray-200 dark:border-gray-800 pt-6">
          <Footer />
        </footer>
